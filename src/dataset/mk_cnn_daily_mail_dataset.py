...
all_train_urls = "../../code/cnn-dailymail/url_lists/all_train.txt"
all_val_urls = "../../code/cnn-dailymail/url_lists/all_val.txt"
all_test_urls = "../../code/cnn-dailymail/url_lists/all_test.txt"
...
def write_to_bin(url_file, out_file, makevocab=False):
  ...
  # write vocab to file
  if makevocab:
    with open(os.path.join(finished_files_dir, "vocab"), 'w', encoding="utf8") as writer:
